...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      update(id, color) {
        this.mute = true;
        window.axios.put(`http://arcane-badlands-12927.herokuapp.com/api/cruds/${id}`, { color }).then(() => {
      ...
      del(id) {
        this.mute = true;
        window.axios.delete(`http://arcane-badlands-12927.herokuapp.com/api/cruds/${id}`).then(() => {
